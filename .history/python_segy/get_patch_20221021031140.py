...
if __name__ == '__main__':
    ...
    train_data  = datagenerator(data_dir = root,patch_size = (96,96),stride = (16,16),train_data_num =4000,download=True,datasets =1,aug_times=0,scales = [1], verbose=False,jump=1,agc=False)
