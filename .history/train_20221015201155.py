...
train_data = datagenerator(data_dir = root,patch_size = (256,256),stride = (64,64),train_data_num =5000,download=True,datasets =1,aug_times=0,scales = [1,0.9,0.8],verbose=False,jump=0,agc=False)
