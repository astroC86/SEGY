...
train_data = datagenerator(data_dir = root,patch_size = (256,256),stride = (64,64), train_data_num = float("inf"),download=True,datasets =1,aug_times=0,scales = [1],verbose=False,jump=1,agc=True)
